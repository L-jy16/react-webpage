...
const ImgText = ( porps ) => {
  return (
    <section id="imgTextType" className={`imgText__wrap ${porps.element}`}>
        <h2 className="blind">{porps.title}</h2>
        <div className="imgText__inner container">
            <div className="imgText__txt">
                <span className="small">이미지 텍스트 유형</span>
                <h3 className="title">유용한 사이트 살펴보기</h3>
                <p className="desc">웹디자이너, 웹 퍼블리셔, 프론트 엔드 개발자를 위한 유용한 사이트입니다.</p>
                <ul className="list">
            ...
            <div className="imgText__img img2">
                <a href="/" className="black">튜톨리어 사이트</a>
            </div>
        </div>
    </section>
  )
